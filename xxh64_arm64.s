...
// 16-byte loads and MADD for fused multiply-add. processes 32 bytes
// per main-loop iteration with 4 independent accumulators.
//
// register allocation:
...
tail8:
	...
	MADD	R16, R7, R10, R16	// h64 = h64*PRIME1 + PRIME4
	B	tail8
...
tail4:
	...
	MADD	R16, R8, R9, R16	// h64 = h64*PRIME2 + PRIME3
...
finalize:
	// avalanche
	LSR	$33, R16, R12
	EOR	R12, R16		// h64 ^= h64 >> 33
	MUL	R8, R16, R16		// h64 *= PRIME2
	LSR	$29, R16, R12
	EOR	R12, R16		// h64 ^= h64 >> 29
	MUL	R9, R16, R16		// h64 *= PRIME3
	LSR	$32, R16, R12
	EOR	R12, R16		// h64 ^= h64 >> 32
